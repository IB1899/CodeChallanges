...
let Hours = document.querySelector("#hours") as HTMLSelectElement;
...
let Minutes = document.querySelector("#minutes") as HTMLSelectElement;
for (let i: any = 0; i <= 59; i++) {
...
let Setting = document.querySelector(".settings") as HTMLDivElement;

//! To set or clear the alarm
let IsAlarmSated: boolean = false;

//! The satedAlarm by the user
let satedAlarm: string;

//* PM or AM
let Time = document.querySelector("#time") as HTMLSelectElement;
...
let time = document.querySelector(".time") as HTMLHeadElement;
...
setInterval(() => {
    ...
    let TwelveHourFormat: any = (date.getHours() + 24) % 12 || 12;
